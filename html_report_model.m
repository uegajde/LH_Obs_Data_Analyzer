function html_report = html_report_model(prereport,settings)
    % initialize
    seperate = '<hr/>';
    html_report = {'<!DOCTYPE html>';...
                    '<html lang="zh-tw">';...
                        '<head>';...
                            ...
                            '<title>L&S'' ODA Analysis Report</title>';...
                        '</head>';...
                        '<body>';...
                            '<div id="fast_shift">';...
                                '<b>Move to...</b>';...
    ...
    html_report = [html_report;'</div>';'<h1>Observation Data Analysis Report</h1>'];
    ...
    if (settings.degree==6)
        for i=1:5
            ...
            for j=1:i+1
                coe = [coe;['<td>obs<sup>',num2str(j-1),'</sup></td>']];
            end
            coe = [coe;'</tr><tr>'];
            for j=1:i+1
